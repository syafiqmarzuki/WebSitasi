                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="col-lg-8">
                            <input type="text" class="form-control" name="nm_ptgs" placeholder="Masukan Nama" style="width: 335px;">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-8">
                            <textarea rowspan="2" class="form-control" placeholder="Masukan Alamat" style="width: 335px;" name="alamat_ptgs"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-8">
                            <input type="text" class="form-control" name="telepon" placeholder="Masukan Nomor Telepon" style="width: 335px;">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-8">
                            <input type="text" class="form-control" placeholder="Masukan Username" style="width: 335px;" name="username">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-8">
                            <input type="password" class="form-control" placeholder="Masukan Password" style="width: 335px;" name="password">
                          </div>
                        </div>
                          ...
                          while ($row = $admins->fetch(PDO::FETCH_OBJ)) {
                            ...
                            <td><?php echo $no; ?></td>
														...
														<td>
															...
															<a href="#hapuspetugas" data-toggle="modal" class=""><i class="fa fa-trash-o"></i></a>
														</td>
                            ...
                            <div class="modal fade" id="editpetugas<?php echo $row->id_ptgs; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <?php
                                    $admin = $objAdmin->showById($row->id_ptgs);
                                    while ($rowAdmin = $admin->fetch(PDO::FETCH_OBJ)) {


                                    ?>
                                    
                                    <form action="pages/Data Master/Data Petugas/update.php?id_ptgs=<?php echo $row->id_ptgs; ?>" method="post">
                                       <div class="container-fluid">
                                        <div class="box-body">
                                          <div class="row">
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-8">
                                              <input type="text" class="form-control" value="<?php echo $row->nm_ptgs; ?>" name="nm_ptgs" style="width: 335px;">
                                            </div>
                                          </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-8">
                                            <textarea rowspan="2" class="form-control"  style="width: 335px;" name="alamat_ptgs" value="<?php echo $row->alamat_ptgs; ?>"></textarea>
                                          </div>
                                        </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-8">
                                            <input type="text" value="<?php echo $row->telepon; ?>" class="form-control" name="telepon"  style="width: 335px;">
                                          </div>
                                        </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-8">
                                            <input type="text" class="form-control" style="width: 335px;" name="username">
                                          </div>
                                        </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-8">
                                            <input type="password" class="form-control" style="width: 335px;" name="password">
                                          </div>
                                        </div>
                            ...
                            <div class="modal fade" id="hapuspetugas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">

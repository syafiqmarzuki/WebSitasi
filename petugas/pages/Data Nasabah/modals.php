  ...
  <!-- insert modal dialog-->
  <div class="modal fade" id="tambahnasabah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
          <!-- <div class="modal-header"> -->
            <div class="modal-header" style="background-color: #4286f4;">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <center><h3 class="modal-title" id="myModalLabel" style="color: #fff">Tambah Nasabah</h3></center>
              </div>
                      ...
                      <div class="box-body">
                        ...
                        <div style="height:10px;"></div>
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-8">
                            <input type="password" class="form-control" name="no_rek" placeholder="Masukan Password" style="width: 335px;">
                          </div>
                        </div>
                        <div style="height:10px;"></div>
